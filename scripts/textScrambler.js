let descMessage = "Self taught developer with Knowledge of HTML, CSS, Javascript, MySQL, Bubble.io and other technologies. Feel free to browse through my projects :)";
...
let changeSpans = (message, iterator) => {
    ...
    let newTime = setTimeout(function(){changeSpans(message, iterator)}, descrambleTimeout);
}
